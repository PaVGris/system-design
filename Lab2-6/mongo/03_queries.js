// queries.js — MongoDB запросы для всех CRUD операций
// Запуск: mongosh mongodb://localhost:27017/store_db queries.js
...
// Используем явный поиск + push только при отсутствии
// (addToSet не работает с объектами по полю — используем условный upsert)
const userId = 1;
